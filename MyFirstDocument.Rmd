...
mean(c(1,2,3,4,5))
```
Here is an example of a non-numbered list (four space rule):
...
Here is an example of code in a blockquote (five space rule):
...
```{r pressure2, fig.with=5, fig.heigh=5, echo = FALSE}
plot(pressure)
```
...
knitr::kable(head(cars),
             caption = "Top 6 Rows of Card Dataset")
```
